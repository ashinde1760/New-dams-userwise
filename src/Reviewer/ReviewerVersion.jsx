...
const Product = () => {
  ...
  function DisableDocument() {
    ...
    fetch(` ${process.env.REACT_APP_API_KEY}/document/isapproved/${id} `, {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  // const DisableDocument = async () => {
   
  //   axios
  //     .put(
  //       `${process.env.REACT_APP_API_KEY}/document/isapproved/${id} `
  //     )
  //     .then((res) => {
  //       console.log(res, "approve applied///////////////,///");
  //       // setUser(res.data);
  //     });
                    ...
                    <TabPanel className="tabview-header" header="Section">
                      ...
                      <ScrollPanel style={{ width: "100%", height: "315px" }}>
                        ...
                        <DataTable
                          ...
                          loading={loading}
                        >
                          <Column field="comment" header="Comments" ro />
                        </DataTable> */}
